...
Output: data/processed/ablations/agentic_vs_vanilla_rag_n30.json
"""
...
OUT = BASE / "data/processed/ablations/agentic_vs_vanilla_rag_n30.json"
...
for t, lst in by_type.items():
    rng.shuffle(lst)
    sample.extend(lst[:6])  # 6 per issue_type
sample = sample[:30]
...
summary = {
    "method": ("Agentic vs vanilla RAG empirical comparison. Vanilla = existing single-shot "
               ...
               "Stratified 30-review sample (6 per issue type)."),
